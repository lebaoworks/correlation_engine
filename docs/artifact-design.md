...
> The design methodology used to build the visual artifacts in this project (e.g.
> [`sensor-design.html`](sensor-design.html)). Captured here as a reference so future
> design work stays consistent.
